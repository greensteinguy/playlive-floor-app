// Tournament create operation. Assembles a full Tournament document from the
// create form's inputs, filling the fields the form doesn't own — live state,
// derived counters, audit — then persists it with whole-document validation
// (validatedSet re-runs the schema's superRefine invariants before the write).
//
...
// Firestore-rules layers (manager-only); this module assembles, validates, and
// writes a best-effort audit row — matching templates.js and the wallet/players
// domain modules.

import { Timestamp } from 'firebase/firestore'
import { validatedSet, auditLog, paths, generateId } from '../firestore'
